...
class Custom2View(ViewBase):
    """
    Example custom view that displays unit information, but has a different
    background color than Custom1View.
    ...
    def _qt_make_layout(self):
        ...
        # Add a title label
        title_label = QT.QLabel("<h2>Custom 2 View Example (same as 1, with a different color!)</h2>")
